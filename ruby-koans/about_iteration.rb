...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # NOTE: 'inject' starts with given argument, runs the given block on 
    # each item accumulating the result and finally returns it.
  end
  ...
  # ANSWER: Because the first way is cleaner and more compact. Besides, we
  # aren't using the file anymore on the method so storing it in a variable
  # isn't neccessary.
