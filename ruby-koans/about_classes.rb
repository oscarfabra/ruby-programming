...
class AboutClasses < Neo::Koan
  ...
  def test_you_can_politely_ask_for_instance_variable_values
    ...
    # Note: 'instance_variable_get' returns nil if instance variable doesn't
    # exist.
  end
  ...
  def test_you_can_rip_the_value_out_using_instance_eval
    ...
    # Note: 'instance_eval' returns nil if instance variable doesn't
    # exist.
  end
  ...
  class Dog7
    ...
    def inspect     # Accessed: :instance_name.get_self
      "<Dog named '#{name}'>"
    end
  end
