...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Answer: To distinguish normal method calls from sending messages to 
    # the object.
  end
  ...
  def test_classes_can_be_asked_if_they_know_how_to_respond
    ...
    # Note: 'respond_to?' tells whether a method is defined.
  end
  ...
  def test_all_messages_are_caught
    ...
    # Note: 'method_missing', when defined, is called by default when any 
    # non-defined method is called on an object.
  end
  ...
  class WellBehavedFooCatcher
    def method_missing(method_name, *args, &block)
      if method_name.to_s[0,3] == "foo"  # [0,3] gets the first 3 characters.
        "Foo to you too"
      else
