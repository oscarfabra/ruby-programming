...
class AboutScope < Neo::Koan
  ...
  def test_nested_string_is_not_the_same_as_the_system_string
    assert_equal false, String == "HI".class # "HI".class is the system String
  end
  ...
  MyString = ::String  # MyString equals the system's String

  def test_class_names_are_just_constants
    assert_equal true, MyString == ::String
    assert_equal true, MyString == "HI".class # Because MyString is ::String
  end
