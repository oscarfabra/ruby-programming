...
class AboutClassMethods < Neo::Koan
  ...
  def test_you_can_define_methods_on_individual_objects
    fido = Dog.new
    def fido.wag        # Defines a method only for instance fido
      :fidos_wag
    end
  ...
  def test_other_objects_are_not_affected_by_these_singleton_methods
    fido = Dog.new
    rover = Dog.new
    def fido.wag        # It's only defined for instance fido
      :fidos_wag
    end
  ...
  # Answer: First option when there's one or little number of class methods.
  # Second option when there are lots of them. For readability.
